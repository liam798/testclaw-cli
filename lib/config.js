...
function buildConfig(overrides = {}) {
  ...
  const config = {
    ...
    memhubCredentials,
    sharedMemHubCredential,
    authMode: tokenFromEnv ? "env_token" : (legacyToken ? "legacy_sonic_token" : (sharedMemHubCredential ? "memhub" : (savedOauthAccessToken ? "oauth_compat" : "missing"))),
    tokenSource: tokenFromEnv ? "env" : (legacyToken ? "auth" : (sharedMemHubCredential ? "memhub_shared" : (savedOauthAccessToken ? "auth_oauth" : "missing"))),
    user: sharedMemHubCredential?.user || null,
  };
